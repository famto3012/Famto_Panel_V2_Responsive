    ...
    <div className="flex-grow h-[600px] flex flex-col">
      <div className="w-full h-[75px] p-1 bg-white shadow-md rounded-xl rounded-bl-none rounded-br-none">
        <div className="flex p-2 align-middle items-center">
          <div className="p-2 md:hidden rounded-full mr-1 hover:bg-gray-400 text-gray-700">
            <svg
          ...
          <div className="p-2 text-gray-700 cursor-pointer hover:bg-gray-200 rounded-full">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-6 w-6"
              fill="none"
      ...
      <div className="w-full flex-grow bg-gray-200 my-2 p-2 overflow-y-auto">
        <div className="flex items-end w-3/4">
          ...
          <div className="p-3 bg-gray-100 mx-3 my-1 rounded-2xl rounded-bl-none sm:w-3/4 md:w-3/6">
            <div className="text-xs text-gray-600">Rey Jhon A. Baqurin</div>
        ...
        <div className="flex justify-end">
          <div className="flex items-end w-auto bg-green-500 m-1 rounded-xl rounded-br-none sm:w-3/4 md:w-auto">
            <div className="p-2">
              <div className="text-gray-100">Hello ? How Can i help you ?</div>
            </div>
          </div>
        </div>
        <div className="flex items-end w-3/4">
          ...
          <div className="p-3 bg-gray-100 mx-3 my-1 rounded-2xl rounded-bl-none sm:w-3/4 md:w-3/6">
            ...
            <div className="text-gray-700">Hello po ang pogi niyo :)</div>
      ...
      <div className="h-[80px]  p-3 rounded-xl rounded-tr-none rounded-tl-none bg-gray-100">
        <div className="flex items-center">
          ...
          <div className="search-chat h-[50px] flex flex-grow p-2">
            <input
              className="input text-gray-700 text-sm p-5 focus:outline-none bg-gray-100  flex-grow rounded-l-md"
              type="text"
