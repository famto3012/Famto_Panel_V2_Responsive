...
import {
  fetchSingleCustomOrderBanner,
  updateCustomOrderBannerDetail,
...
const EditBanner = ({ isOpen, onClose, bannerId }) => {
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: ["custom-order-banner", bannerId],
    queryFn: () => fetchSingleCustomOrderBanner(bannerId, navigate),
    enabled: isOpen,
  });
  ...
  const handleEditBanner = useMutation({
    mutationKey: ["edit-custom-order-banner", bannerId],
    mutationFn: (data) =>
      updateCustomOrderBannerDetail(bannerId, data, navigate),
    onSuccess: () => {
