...
import { addMoneyToWallet } from "@/hooks/customer/useCustomer";

const AddMoney = ({ isOpen, onClose, customerId }) => {
  ...
  const { mutate, isPending } = useMutation({
    mutationKey: ["add-monet-to-wallet", customerId],
    mutationFn: ({ customerId, amount }) =>
      addMoneyToWallet(customerId, amount, navigate),
    onSuccess: () => {
    ...
    onError: () => {
      toaster.create({
        title: "Error",
        description: "Error while adding amount to wallet",
        type: "error",
      });
    },
  });
